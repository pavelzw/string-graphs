...
\begin{frame}{Relationships between realizability functions}
    \begin{lemma}
        ...
        \end{enumerate}
    \end{lemma}
    \(\leadsto\) \(c_w\), \(c_r\) and \(c_s\) are polynomially equivalent.
\end{frame}
...
\begin{frame}{Exponential Representations}
    \centering{}\includegraphics<1>[width=0.8\textwidth]{images/figure-11.png}\includegraphics<2>[width=0.8\textwidth]{images/figure-12.png}
\end{frame}
